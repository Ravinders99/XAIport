...
async def run_model1_background(dataset_id: str, perturbation_func_name: str, severity: int, background_tasks: BackgroundTasks):
    ...
    local_performance_path = os.path.join(script_dir, "modelserver/performance/datasets/")

    # 定义 Blob 存储中的目标路径
    cloud_performance_path = f"performance/{dataset_id}_{perturbation_func_name}_{severity}"
